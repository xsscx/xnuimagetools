...
leaks --atExit -- /tmp/xnuimagetools
```
...
DYLD_INSERT_LIBRARIES=/usr/lib/libgmalloc.dylib /tmp/xnuimagetools
...
### VideoToolbox / AVFoundation debugging
```bash
# VTDecompressionSession logging
export VT_VERBOSE=1
export VIDEOTOOLBOX_DEBUG=1

# AVFoundation verbose
export AVF_LOG_LEVEL=4

# Metal shader validation (GPU-side bounds checking)
